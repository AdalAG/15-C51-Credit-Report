...
% ── Title block ───────────────────────────────────────────────────────────────
\title{\textbf{Credit Approval Rule Analysis}\\[0.4em]
\large UCI Credit Approval Dataset $\cdot$ Explainability-First ML Pipeline}
\author{
  15.C51 $\cdot$ Modeling with Machine Learning: Financial Technology\\
